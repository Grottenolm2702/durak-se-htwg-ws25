...
trait GameState:
  ...
  /** Cards currently on the table.
    * Maps attack cards to their optional defense cards (None if undefended).
    */
  ...
  /** Index of the round winner (defender if they successfully defended), if any. */
  ...
  /** Converts this game state to a builder for further modifications.
    * @return A GameStateBuilder initialized with this state's values
    */
  ...
  /** Creates a copy of this game state with specified fields modified.
    ...
    * @param discardPile The discarded cards
    * @param trumpCard The trump card
    * @param attackerIndex The main attacker's index
    * @param defenderIndex The defender's index
    * @param gamePhase The current game phase
    * @param lastEvent The last event that occurred
    * @param passedPlayers Set of players who passed
    * @param roundWinner The round winner's index
    * @param setupPlayerCount The player count from setup
    * @param setupPlayerNames The player names from setup
    * @param setupDeckSize The deck size from setup
    * @param currentAttackerIndex The current attacker's index
    * @param lastAttackerIndex The last attacker's index
    * @return A new GameState with the specified modifications
    */
  def copy(
