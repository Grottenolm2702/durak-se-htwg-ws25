 ...
 * 
 * This is the public port to the Model component. All external access
 * to model types must go through this interface.
 * 
 * Exports:
 ...
 * GameState Interface
 * 
 * Defines the external contract for accessing game state.
