...
/** Model Component Interface
  ...
  * game's domain logic including cards, players, game state, and phase management.
  *
...
object ModelInterface:
  ...
  /** Factory for creating GameStateBuilder instances.
    *
    * The builder provides a fluent API for constructing GameState objects
  ...
  object GameStateBuilder:
    /** Creates a new GameStateBuilder instance.
      *
      * @return A new builder for constructing GameState objects
      */
  ...
  /** Factory for creating Card instances.
    *
    * Cards are immutable and represent a playing card with a suit, rank,
    * and optional trump status.
    */
  object Card:
    /** Creates a new Card.
      *
      * @param suit The suit of the card (Hearts, Diamonds, Clubs, or Spades)
      * @param rank The rank of the card (Six through Ace)
      * @param isTrump Whether this card is a trump card (default: false)
  ...
  /** Factory for creating Player instances.
    *
    * Players have a name, a hand of cards, and a done status indicating
    * whether they have no more cards and have finished the game.
    */
  object Player:
    /** Creates a new Player.
      *
      * @param name The player's name
      * @param hand The cards currently in the player's hand (default: empty)
      * @param isDone Whether the player has finished (no cards left) (default: false)
  ...
  object GameState:
    /** Creates a new GameState.
      ...
      * @param table Map of attack cards to their optional defense cards
      * @param discardPile Cards that have been played and discarded
      * @param trumpCard The trump card determining the trump suit
      * @param attackerIndex Index of the current main attacker
      * @param defenderIndex Index of the current defender
      * @param gamePhase The current phase of the game
      * @param lastEvent The last event that occurred (default: None)
      * @param passedPlayers Set of player indices who have passed this round (default: empty)
      * @param roundWinner Index of the round winner, if any (default: None)
      * @param setupPlayerCount Player count from setup phase (default: None)
      * @param setupPlayerNames Player names from setup phase (default: empty)
      * @param setupDeckSize Deck size from setup phase (default: None)
      * @param currentAttackerIndex Index of the current active attacker (default: None)
      * @param lastAttackerIndex Index of the last player who attacked (default: None)
