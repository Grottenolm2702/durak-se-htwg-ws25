...
/** Controller Component Interface
  ...
  * the mediator between the Model (game state) and View (user interface) components.
  *
...
object ControllerInterface:
  ...
  /** Type alias for the Controller trait.
    * The main controller interface for game flow management.
    */
  type Controller = InternalController
  
  /** Type alias for the CommandInterface.
    * Provides access to the command pattern implementation.
    */
  type CommandInterface = InternalCommandInterface.type
  
  /** Type alias for GameCommand.
    * Represents executable game commands that can be undone/redone.
    */
  type GameCommand = InternalGameCommand
  
  /** Type alias for PlayerAction.
    * Base trait for all player actions in the game.
    */
  type PlayerAction = InternalPlayerAction
  
  /** Type alias for PlayCardAction.
    * Action to play a specific card.
    */
  type PlayCardAction = InternalPlayCardAction
  
  /** Type alias for SetPlayerCountAction.
    * Action to set the number of players during setup.
    */
  type SetPlayerCountAction = InternalSetPlayerCountAction
  
  /** Type alias for AddPlayerNameAction.
    * Action to add a player name during setup.
    */
  type AddPlayerNameAction = InternalAddPlayerNameAction
  
  /** Type alias for SetDeckSizeAction.
    * Action to set the deck size during setup.
    */
  ...
  object Controller:
    /** Creates a new Controller instance.
      ...
      * @param undoRedoManager The undo/redo manager for command history
